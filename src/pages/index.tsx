    ...
    <>
      ...
      <section className="tw-space-y-title">
        <h1 className={`
          ...
          tw-relative before:tw-opacity-[var(--o-rainbows)] before:tw-absolute before:tw-inset-0 before:tw-z-muted before:tw-bg-[radial-gradient(35%_45%_at_35%_45%,_rgb(var(--c-i-base),_0.3),_rgba(var(--c-i-base),_0)),_radial-gradient(30%_50%_at_50%_50%,_rgb(var(--c-i-accent-5),_0.2),_rgba(var(--c-i-accent-5),_0)),_radial-gradient(35%_45%_at_65%_55%,_rgb(var(--c-i-accent-4),_0.3),_rgba(var(--c-i-accent-4),_0)),_radial-gradient(30%_30%_at_70%_60%,_rgb(var(--c-i-accent-1),_0.4),_rgba(var(--c-i-accent-1),_0)),_radial-gradient(50%_0.5em_at_center,_rgb(var(--c-i-accent-2),_0.4),_rgba(var(--c-i-accent-2),_0))]
        `}>
          <Trans
            i18nKey="index.title"
            components={[
