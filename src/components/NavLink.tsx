      ...
      trigger={
        <Link
          ...
          className={classNames(
            '!tw-outline-none !tw-border-0 tw-text-2xl tw-flex tw-p-3 tw-relative tw-duration-fast before:tw-bg-[rgb(var(--c-navlink))] before:tw-mask-radial before:tw-absolute before:tw-inset-0 before:tw-duration-normal',
